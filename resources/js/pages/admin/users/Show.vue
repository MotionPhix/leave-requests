    ...
    <div class="p-6">
      ...
      <div class="mb-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 items-center gap-4">
          <Badge class="grid divide-y w-full">

            <span class="flex items-center gap-2 pb-2">
          ...
          <Badge class="capitalize grid divide-y w-full"
                 :variant="user.employment_status === 'active'
                  ? 'default'
                  : 'destructive'">
            <span class="flex items-center gap-2 pb-2">
            ...
            <Tabs :default-value="activeTab"
              ...
              <TabsContent value="balances">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Card v-for="balance in leaveBalances"
                        :key="balance.type">
